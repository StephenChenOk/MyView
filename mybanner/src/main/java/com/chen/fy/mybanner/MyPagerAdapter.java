...
public class MyPagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        ...
        ImageView imageView = MainActivity.images.get(position % MainActivity.images.size());
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:   //手指按下
                        MainActivity.handler.removeCallbacksAndMessages(null);  //移除所有的回调以及消息
                        break;
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(myContext, MainActivity.imagesTitle[position%MainActivity.images.size()], Toast.LENGTH_SHORT).show();
            }
        });
